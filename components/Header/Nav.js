...
function Nav() {
  return (
    <div className="bg-[#0e5aa7] p-2 font-montserrat lg:p-0">
      <div className="mx-auto flex max-w-7xl justify-between space-x-1 py-1 md:py-4">
        <div className="flex flex-1 space-x-3 md:mr-5 lg:space-x-8">
          <div className="flex rounded-lg bg-modified-blue p-1 text-white lg:hidden">
            <svg
          ...
          <a data-testid="carrefour_logo" href="/" className="css-5q0vk4">
            <svg
              data-testid="Carrefour"
              viewBox="0 0 730.69 182.35"
              className="w-[100px] md:w-[120px] lg:w-40"
            >
              <path
                fill="#fff"
              ...
              <path
                fill="#ee2527"
                d="M141.87,56.11c-50.47,0-85.72,34-85.72,79.13v89.2H85.44s0-49.07,0-89.27c0-41.95,31.82-71.88,63.76-78.37,1.3-.28,2.82-.69,1.3-.69Z"
                transform="translate(-56.15 -42.1)"
              ></path>
            </svg>
          </a>
          <div className="hidden w-full rounded-[4px] bg-gray-100 pl-5 md:flex">
            <input
              className="w-full bg-gray-100 text-[10px] focus:outline-none md:text-sm"
              type="text"
              placeholder="Search Products..."
            />
            <button className="rounded-r-[4px] bg-red-600 p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex text-white">
          <div className="hidden cursor-pointer items-center space-x-3 border-r-[0.05px] border-l-[0.05px] border-modified-blue px-4 lg:flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7"
              fill="none"
          ...
          <div className="relative mr-2 cursor-pointer transition ease-in-out hover:-translate-y-1 hover:scale-110 md:mt-1 md:ml-3 xl:mr-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7"
              fill="none"
      ...
      <div className="mt-1 flex w-full rounded-[4px] bg-gray-100 pl-5 md:hidden">
        <input
          className="w-full bg-gray-100 text-[10px] focus:outline-none md:text-sm"
          type="text"
          placeholder="Search Products..."
